...
export default function Project() {
  ...
  return (
    <div className='w-full h-full pt-24 sm:pt-26'>
      <div className='flex flex-col items-center justify-between sm:justify-around gap-6'>
      ...
      '
        >
          <ul className='w-full overflow-x-auto  scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-gray-200 rounded-lg px-0.5 sm:px-0'>
            {itemsApi.map((item) => (
              <li
                key={item.id}
